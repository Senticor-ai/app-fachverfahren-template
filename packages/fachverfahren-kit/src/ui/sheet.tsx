...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-(--fv-duration-surface) data-[state=open]:duration-(--fv-duration-reveal) data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
