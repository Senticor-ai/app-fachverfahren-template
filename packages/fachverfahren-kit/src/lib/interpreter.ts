...
// Liegt SELF-CONTAINED in `./governance.js` (nur type-only Imports), damit die strip-types-Contract-Gates es laden
// koennen; hier nur re-exportiert, damit `abgeleiteteTransitions` weiter aus dem Interpreter/Barrel importierbar ist.
export {
