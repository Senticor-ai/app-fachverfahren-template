...
export function MarkdownEditor({
  ...
  return (
    <div
      className={cn(
        "flex h-full min-h-[16rem] flex-col rounded-lg border border-border bg-card",
        className,
      )}
    >
      <div
        ...
        {preview === "tab" && (
          ...
          >
            <button
              ...
              onClick={() => setTab("edit")}
              className={cn(
                "inline-flex items-center gap-1 rounded px-2 py-1 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
                tab === "edit"
