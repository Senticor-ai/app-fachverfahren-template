// fachverfahren-kit/components/ProzessEditor — formular-/listenbasierter Autorenpfad für die eigene,
// BPMN-inspirierte `ProzessDefinition`. Die Mermaid-Anzeige ist nur eine Vorschau; Änderungen laufen kontrolliert
// über `beiAenderung(neueDefinition)`. Accessibility-Eigenschaften werden automatisiert und manuell geprüft, sind
// aber keine pauschale Konformitätsaussage.
    ...
    <div className="flex flex-col gap-6">
      ...
      >
        {fehler.length === 0 ? (
          ...
          <div>
            <p className="font-medium text-status-block">
