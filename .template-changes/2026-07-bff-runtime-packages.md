...
Registrar-Nähten, TypeBox-Wire-Verträge und BFF-Routen
...
apps/\*/server/**, scripts/check-*.mjs, schemas/**) kommen über
template:update; die Migration ergänzt die konsumenten-eigene Verdrahtung
(Workspace-Deps, tsconfig-Referenzen, vitest-Aliase, Dockerfile-COPYs,
Catalog-Einträge, CI-Schritte).
