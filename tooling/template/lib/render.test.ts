...
describe("domain app rendering", () => {
  // Zwei volle Repo-Renders: auf den langsamen opencode.de-Runnern (siehe vitest.config.ts) schon
  // mit 8.2s beobachtet — bei 2-3x Runner-Varianz reicht das globale 20s-Budget nicht sicher.
  it(
    "renders deterministic full-repo template provenance",
    { timeout: 60_000 },
    async () => {
