...
const updateUnmanagedPaths: string[] = [
  ...
  "docs/examples/**",
  "docs/security/**",
  // Reconcile mit feat/prod-wiring-workflow-collaboration: unsere Maintainer-Gates/Tests +
  // GitHub-Vorlagen — gescaffoldet, aber Konsumenten-Hoheit (kein template:update-Zwang).
  ".github/ISSUE_TEMPLATE/**",
  ".github/PULL_REQUEST_TEMPLATE.md",
  ".github/dependabot.yml",
  "THIRD-PARTY-NOTICES.md",
  "tsconfig.domain-servers.json",
  "scripts/check-bsi-grundschutz.mjs",
  "scripts/check-contrast-tokens.mjs",
  "scripts/check-package-licenses.mjs",
  "scripts/check-schema-invariants.mjs",
  "scripts/e2e-domain-api.sh",
  "scripts/sync-claude-skill-shims.mjs",
  "scripts/ux-workspace.mjs",
  "tests/simulation/**",
