...
**Generelle Invariante:** _Kein Statuswechsel / Bescheid / Festsetzung ohne menschliche, serverseitig erzwungene
Bestätigung_ (humanDecisionsServerSide); bei Außenwirkung zusätzlich 4-Augen (four-eyes-server). UI-Kennzeichnung
